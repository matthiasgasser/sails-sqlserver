...
module.exports = (function () {
  ...
  var adapter = {
    ...
    define: function (connection, collection, definition, cb) {
      ...
      var collectionSails = connections[connection].collections[collection];
      var schemaName = collectionSails.meta && collectionSails.meta.schemaName ? escapeName(collectionSails.meta.schemaName) + '.' : '';
      var tableName = schemaName + escapeName(collection);
